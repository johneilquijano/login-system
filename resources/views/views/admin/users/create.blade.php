        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-xs mt-1">At least 8 characters with uppercase, lowercase, and numbers</p>
                    @error('password')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="px-6 py-2 bg-gray-200 text-gray-900 rounded-lg hover:bg-gray-300 font-medium">
                        Cancel
                    </a>
                </div>
            </form>
