        ...
        <div class="flex flex-row h-screen">
            ...
            <div class="flex-1 overflow-auto">
                ...
                <div class="p-8">
                    ...
                    <!-- Back Button -->
                    <a href="{{ route('inventory-requests.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-semibold mb-6">
                    ...
                    <div class="grid grid-cols-3 gap-8">
                        ...
                        <div class="col-span-2 space-y-6">
                            ...
                            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                                ...
                                <div class="grid grid-cols-2 gap-6 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-semibold text-gray-900">{{ $inventoryRequest->items->count() }}</p>
                                    </div>
                                </div>
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                                ...
                                                <td class="px-4 py-3 text-sm text-gray-900 font-semibold text-center">
                                                    ...
                                                    @if($item->fulfilled_quantity < $item->quantity)
                                                        <span class="text-xs text-orange-600">({{ $item->getRemainingQuantity() }} pending)</span>
                                                    @endif
                                                </td>
                            ...
                            <div class="bg-blue-50 rounded-lg shadow-md border border-blue-200 p-6">
                                ...
                                <p class="text-gray-900">{{ $inventoryRequest->admin_notes }}</p>
                            </div>
                            @endif
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6 mb-6">
                                <h3 class="text-lg font-bold text-gray-900 mb-6">Timeline</h3>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex gap-4">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <div class="w-0.5 h-8 bg-gray-300 flex-1"></div>
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex gap-4">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Denied</p>
                                    ...
                                    <div class="flex gap-4">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Fulfilled</p>
                            ...
                            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                                ...
                                <div class="space-y-3">
                                    <!-- Edit (Draft only) -->
                                    @if($inventoryRequest->status === 'draft')
                                    <a href="{{ route('inventory-requests.edit', $inventoryRequest) }}" class="block w-full text-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg transition">
                                        Edit Request
                                    </a>
                                    @endif
                                    ...
                                    <!-- Back to List -->
                                    <a href="{{ route('inventory-requests.index') }}" class="block w-full text-center border border-gray-300 text-gray-900 font-semibold py-2 px-4 rounded-lg hover:bg-gray-50 transition">
                                        Back to List
                                    </a>
                                </div>
                            </div>
