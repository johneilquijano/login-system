<div class="dashboard-sidebar hidden lg:flex flex-col w-64 bg-white shadow-lg h-screen sticky top-0">
    <div class="h-16 bg-brand-100 flex items-center px-6">
        <h1 class="text-gray-900 font-bold text-xl">Admin Panel</h1>
    </div>
    ...
    <nav class="dashboard-nav flex flex-col flex-1 mt-6 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('admin.audit-logs.index') }}" @class([
            'w-full flex items-center px-6 py-3 border-l-4 transition',
            'border-purple-600 bg-purple-50 text-purple-700 font-semibold' => request()->routeIs('admin.audit-logs.*'),
            'border-transparent hover:border-gray-300 text-gray-700 hover:bg-gray-50' => !request()->routeIs('admin.audit-logs.*')
        ])>
            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-4">System</div>

        <a href="{{ route('feedback.my') }}" @class([
            'w-full flex items-center px-6 py-3 border-l-4 transition',
            'border-purple-600 bg-purple-50 text-purple-700 font-semibold' => request()->routeIs('feedback.my'),
            'border-transparent hover:border-gray-300 text-gray-700 hover:bg-gray-50' => !request()->routeIs('feedback.my')
        ])>
            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
