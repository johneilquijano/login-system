<div class="dashboard-sidebar hidden lg:flex flex-col w-64 bg-white shadow-lg h-screen sticky top-0">
    ...
    <nav class="dashboard-nav flex flex-col flex-1 mt-6 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('vehicles.index') }}" @class([
            'w-full flex items-center px-6 py-3 border-l-4 transition',
            'border-blue-600 bg-blue-50 text-blue-700 font-semibold' => request()->routeIs('vehicles.*'),
            'border-transparent hover:border-gray-300 text-gray-700 hover:bg-gray-50' => !request()->routeIs('vehicles.*')
        ])>
            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('feedback.my') }}" @class([
            'w-full flex items-center px-6 py-3 border-l-4 transition',
            'border-blue-600 bg-blue-50 text-blue-700 font-semibold' => request()->routeIs('feedback.my'),
        ...
        <a href="{{ route('notifications.index') }}" @class([
            'w-full flex items-center px-6 py-3 border-l-4 transition',
            'border-blue-600 bg-blue-50 text-blue-700 font-semibold' => request()->routeIs('notifications.*'),
